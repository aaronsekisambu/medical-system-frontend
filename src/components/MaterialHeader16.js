...
function MaterialHeader16(props) {
  return (
    <Container {...props}>
      <TextWrapper1Row>
        <TextWrapper1>
          <Title numberOfLines={1}>Order confirmation</Title>
        </TextWrapper1>
        <LeftIconButton1Stack>
          <Link to="/Untitled5">
            <LeftIconButton1>
              <ButtonOverlay>
                <EntypoIcon
...
const LeftIconButton1Stack = styled.div`
  width: 79px;
  height: 46px;
  margin-left: -233px;
  position: relative;
...
export default MaterialHeader16;
